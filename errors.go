...
var (
	...
	ErrAmbiguousDate     = errors.New("ambiguous date")
	ErrNonexistentTime   = errors.New("nonexistent local time")
	ErrDuplicateTime     = errors.New("duplicate local time")
	ErrIntervalReversed  = errors.New("interval end before start")
	ErrIntervalsDisjoint = errors.New("intervals disjoint")
